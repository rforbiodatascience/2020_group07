...
## Introduction {data-background="Rmd_sup/02.1.breast.jpg" data-background-size=cover}
### Data set:
...
knitr::include_graphics("Rmd_sup/02.2.classes.png")
```
&nbsp;
...
knitr::include_graphics("Rmd_sup/03.1.dataset.png")
```
...
```{r,out.width =  "1000px"}
knitr::include_graphics("Rmd_sup/04.1.clean_augment.png")
```
...
knitr::include_graphics("Rmd_sup/05.1.models.png")
```
  
  
```{r,  out.width =  "600px", fig.align = 'center'}
knitr::include_graphics("Rmd_sup/05.2.tidyverse_workflow.png")
```

## Material and Methods {data-background=#ffffff}
```{r, out.width = "950px", fig.align = 'center'}
knitr::include_graphics("../doc/Rmd_sup/06.file_systems_chart.png")
```
...
```{r,out.width = "1000px"}
knitr::include_graphics("../doc/Rmd_sup/15.1.ANN_structure.png")
```
...
## The end {data-background="Rmd_sup/18.1.final_background.jpg" data-background-size=cover}
